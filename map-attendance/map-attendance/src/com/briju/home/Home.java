...
import com.briju.admin.Admin;
import com.briju.attendance.AddAttendance;
import com.briju.attendance.EditAttendance;
import com.briju.myclass.Class;
import com.briju.student.Students;
import com.briju.teacher.Teachers;
...
public class Home{
	...
	public void homeView(int id) throws SQLException {
		...
		classes.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Class class1 = new com.briju.myclass.Class();
				class1.classView();
			}
		});
		//----------------------------------------------------------
